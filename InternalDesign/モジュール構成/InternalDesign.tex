...
\begin{figure}[H]
    \begin{center}
    \resizebox{16.5cm}{!}{\includegraphics {ゲーム_全体.png}}
...
\subsubsection*{概要}
ここでは、用意されたイラストを閲覧しながらおえかきを描いたり、描いたおえかきを成長記録のアルバムに保存することができます。
...
\subsubsection{おつかい画面モジュールl{おつかい}}
\begin{figure}[H]
    \begin{center}
...
\begin{itemize}
\item　【もどる】をタップすることでゲーム選択画面(第\ref{ゲーム選択}節)に戻ります。
\item　【各料理】をタップすることで選択した料理の材料画面を表示します。
