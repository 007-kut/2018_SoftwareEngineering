...
\begin{figure}[H]
    \begin{center}
    \resizebox{16.5cm}{!}{\includegraphics {子育て窓口_全体.png}} %画像は各自で用意、大きさも自分で調整
...
\begin{figure}[H]
    \begin{center}
    \resizebox{16.5cm}{!}{\includegraphics {子育て窓口_投稿.png}} %画像は各自で用意、大きさも自分で調整
...
\begin{figure}[H]
    \begin{center}
    \resizebox{16.5cm}{!}{\includegraphics {子育て窓口_検索.png}} %画像は各自で用意、大きさも自分で調整
    \caption {子育て窓口モジュールのイメージ}
    \label{functionselection}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
    \resizebox{12.5cm}{!}{\includegraphics {子育て窓口_質問.png}} %画像は各自で用意、大きさも自分で調整
    \caption {子育て窓口モジュールのイメージ}
    \label{functionselection}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
    \resizebox{16.5cm}{!}{\includegraphics {子育て窓口_回答.png}} %画像は各自で用意、大きさも自分で調整
